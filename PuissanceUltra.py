...
def MorpionGame():
    ...
    while term[0] == False:
        ...
        if j==2:
            ...
            dt = time.time()-t1
            print(f"L'adversaire a réflechis {CYEL}{round(dt, 1)}{CEND} sc et joue en {CYEL}{saisie[1]+1}{CEND}")
            ...
            listeT.append(dt)
            nbCoup += 1
            print(f"Notre IA a réflechie {CYEL}{round(dt, 1)}{CEND} sc et joue en {CYEL}{action[1]+1}{CEND}")
